...
{
  category: "connect_flow",
  points: new go.List().addAll([new go.Point(0, 20), new go.Point(80, 20)])
},
{
  category: "CommentFlow",
  points: new go.List().addAll([new go.Point(0, 30), new go.Point(80, 30)])
}];
...
function paletteInit() {
  activityPalette =
    $$(go.Palette, "myPaletteDiv", {
      ...
      maxSelectionCount: 1,
      nodeTemplateMap: activityDiagram.nodeTemplateMap,
      linkTemplateMap: activityDiagram.linkTemplateMap,
